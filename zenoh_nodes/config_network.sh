...
echo -e "To start the simulation execute the following command: \033[1;36mROS_LOCALHOST_ONLY=1 ros2 launch nav2_bringup_multirobot multi_tb3_simulation_launch.py autostart:=True use_sim_time:=True use_composition:=False verbose:=True\033[0m"
