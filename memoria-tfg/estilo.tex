...
\usepackage{graphicx}
\usepackage{color}
\usepackage{xcolor} %more colors for yaml to work
\usepackage{caption}
\usepackage{acronym}
\usepackage{hyphenat}
\usepackage{a4wide}
...
%\usepackage{natbib} % para usar \citep{},  \citet{},  \citeauthor{},  \citeyear{}...
%\usepackage[backend=biber, style=apa, language=spanish]{biblatex} % Añadido para soporte de bibliografía con biblatex
\usepackage[natbibapa]{apacite} %en sustitución al paquete natbib porque era muy antiguo y daba problemas.


% Para que no parta las palabras
%\pretolerance=10000
% Para que parta las palabras
\pretolerance=200
...
\lstdefinestyle{yaml}{
  ...
  morecomment=[l]{\#},
  literate={:}{{\textcolor{red}{:}}}1 % Set the hyphen "-" to red
}
