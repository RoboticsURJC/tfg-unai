...
\end{figure}\
% Imagen de la web https://www.turtlebot.com/about/ bajo la siguiente licencia:
% Creative Commons Atributtion 4.0 (requires appropriate credit — If supplied,
% you must provide the name of the creator and attribution parties, a copyright
% notice, a license notice, a disclaimer notice, and a link to the material. CC
% licenses prior to Version 4.0 also require you to provide the title of the
% material if supplied, and may have other slight differences.)

%(fuente propia)
%\footnote{ibid. 3} %(para referenciar footnotes que ya han salido anteriormente).
...
\end{figure}\
% De https://robots.ros.org/kobuki/ bajo la licencia:Creative Commons
% Attribution 3.0
...
% Imagen de la web https://www.turtlebot.com/turtlebot2/ bajo la licencia
% Creative Commons Atributtion 4.0
...
% De https://www.turtlebot.com/ bajo la licencia Creative Commons Atributtion
% 4.0
...
\end{figure}\
% De https://www.flickr.com/photos/thebetterday4u/47332699541 bajo licencia Creative
% Commons 4.0 (segun google)
...
\end{figure}\
% De https://commons.wikimedia.org/wiki/File:Raspberry_Pi_4_B.png bajo licencia
% Creative Commons 4.0  (segun google)
...
\end{figure}\
% De https://www.trustedreviews.com/reviews/asus-rog-rapture-gt-axe1600 bajo
% licencia Creative Commons 4.0 (segun google)
...
\end{figure}\
% De https://discourse.ros.org/t/new-ros-online-courses-gazebo-simulator-intermediate-ros2-tf-ros2/26774
...
\end{figure}\
% De https://zenoh.io/blog/2023-03-21-zenoh-vs-mqtt-kafka-dds/, habria que
% preguntar a Eclipse Foundation para usar la imagen.
...
\begin{figure} [h!]
  ...
  \label{fig:hsv}
\end{figure}\
% De https://commons.wikimedia.org/wiki/File:HSV_cone.png bajo licencia
...
\begin{figure} [h!]
  ...
  \label{fig:rgb_mat}
\end{figure}\
% De https://en.wikipedia.org/wiki/File:Matl.jpg#filelinks bajo licencia
% Creative Commons 3.0
