...
\texttt{C}.
En concreto utilizaremos la versión 3.10.12 de este lenguaje debido a su
...
equivalente en lenguajes como \texttt{Java}, \texttt{C}, \texttt{Rust} o incluso
\texttt{Android}, entre otros.
\\
...
\begin{figure} [h!]
  ...
  \end{center}
  \caption{Simulación en Gazebo del Turtlebot 3 en un mundo virtual \cite{gazebo}}
