...
\begin{figure} [h!]
  ...
  \end{center}
  \caption{Robots Spot --izquierda-- y Atlas --derecha-- \cite{atlas_spot}.}
...
\begin{figure}[h!]
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \caption{Arduino \cite{arduino_uno}.}
    \label{fig:arduino}
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
...
\begin{figure} [h!]
  ...
  \end{center}
  \caption{Arquitectura de ROS y ROS2 \cite{ros_ros2}.}
  \label{fig:ros}
\end{figure}\
...
\begin{figure} [h!]
  ...
  \end{center}
  \caption{Múltiples robots durante una operación de búsqueda y rescate \cite{multirobot_navigation}.}
